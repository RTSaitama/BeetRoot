...
var Swiper = function () {
  ...
  var I = {
      ...
      if (d && a.loop) {
        ...
        if (a.slidesPerGroup > 1) {
          ...
          for (var _e3 = 0; _e3 < _s6; _e3 += 1) {
            f.push(f[f.length - 1] + _i5);
          }
        }

        for (var _s7 = 0; _s7 < e.virtual.slidesBefore + e.virtual.slidesAfter; _s7 += 1) {
          1 === a.slidesPerGroup && f.push(f[f.length - 1] + _t6), g.push(g[g.length - 1] + _t6), e.virtualSize += _t6;
        }
      }
    ...
    updateSlidesOffset: function updateSlidesOffset() {
      ...
      for (var _a8 = 0; _a8 < t.length; _a8 += 1) {
        t[_a8].swiperSlideOffset = (e.isHorizontal() ? t[_a8].offsetLeft : t[_a8].offsetTop) - s - e.cssOverflowAdjustment();
      }
    },
      ...
      if (l) {
        ...
        var _e9 = function (e, t) {
          ...
          for (; e.nextElementSibling;) {
            var _a11 = e.nextElementSibling;
            t ? _a11.matches(t) && s.push(_a11) : s.push(_a11), e = _a11;
          }
        ...
        s.loop && 0 === !_a10 && (_a10 = t[t.length - 1]), _a10 && _a10.classList.add(s.slidePrevClass);
      }
    ...
    updateClickedSlide: function updateClickedSlide(e, t) {
      ...
      var r,
          n = !1;
      if (i) for (var _e12 = 0; _e12 < s.slides.length; _e12 += 1) {
        if (s.slides[_e12] === i) {
          n = !0, r = _e12;
          break;
        }
    ...
    loopFix: function loopFix(e) {
      ...
      if (o.allowSlidePrev = c, o.allowSlideNext = p, o.controller && o.controller.control && !n) {
        ...
        Array.isArray(o.controller.control) ? o.controller.control.forEach(function (t) {
          !t.destroyed && t.params.loop && t.loopFix(_objectSpread({}, _e23, {
            slideTo: t.params.slidesPerView === m.slidesPerView && s
          }));
        }) : o.controller.control instanceof o.constructor && o.controller.control.params.loop && o.controller.control.loopFix(_objectSpread({}, _e23, {
  ...
  function X(e) {
    ...
    if (r.touchReleaseOnEdges && (T = 0), v > 0 ? (y && E && !x && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
      ...
      setTranslate: !0,
      activeSlideIndex: 0
    }), i.currentTranslate > s.minTranslate() && (S = !1, r.resistance && (i.currentTranslate = s.minTranslate() - 1 + Math.pow(-s.minTranslate() + i.startTranslate + v, T)))) : v < 0 && (y && E && !x && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
      direction: "next",
      setTranslate: !0,
      activeSlideIndex: s.slides.length - ("auto" === r.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(r.slidesPerView, 10)))
    }), i.currentTranslate < s.maxTranslate() && (S = !1, r.resistance && (i.currentTranslate = s.maxTranslate() + 1 - Math.pow(s.maxTranslate() - i.startTranslate - v, T)))), S && (c.preventedByNestedSwiper = !0), !s.allowSlideNext && "next" === s.swipeDirection && i.currentTranslate < i.startTranslate && (i.currentTranslate = i.startTranslate), !s.allowSlidePrev && "prev" === s.swipeDirection && i.currentTranslate > i.startTranslate && (i.currentTranslate = i.startTranslate), s.allowSlidePrev || s.allowSlideNext || (i.currentTranslate = i.startTranslate), r.threshold > 0) {
      ...
      value: function slidesPerViewDynamic(e, t) {
        ...
        if (s.centeredSlides) {
          ...
          for (var _s17 = l + 1; _s17 < a.length; _s17 += 1) {
            a[_s17] && !_e30 && (_t21 += a[_s17].swiperSlideSize, o += 1, _t21 > n && (_e30 = !0));
          }
  ...
  var ce = [function (e) {
    ...
    r("beforeInit", function () {
      ...
      appendSlide: function appendSlide(e) {
        if ("object" == _typeof(e) && "length" in e) for (var _t33 = 0; _t33 < e.length; _t33 += 1) {
          e[_t33] && s.virtual.slides.push(e[_t33]);
      ...
      prependSlide: function prependSlide(e) {
        ...
        if (Array.isArray(e)) {
          for (var _t34 = 0; _t34 < e.length; _t34 += 1) {
            e[_t34] && s.virtual.slides.unshift(e[_t34]);
          }
      ...
      removeSlide: function removeSlide(e) {
        if (null == e) return;
        var t = s.activeIndex;
        if (Array.isArray(e)) for (var _a14 = e.length - 1; _a14 >= 0; _a14 -= 1) {
          s.params.virtual.cache && (delete s.virtual.cache[e[_a14]], Object.keys(s.virtual.cache).forEach(function (t) {
            t > e && (s.virtual.cache[t - 1] = s.virtual.cache[t], s.virtual.cache[t - 1].setAttribute("data-swiper-slide-index", t - 1), delete s.virtual.cache[t]);
          })), s.virtual.slides.splice(e[_a14], 1), e[_a14] < t && (t -= 1), t = Math.max(t, 0);
    ...
    function u() {
      ...
      p.forEach(function (e, r) {
        if ("fraction" === s.type && (e.querySelectorAll(ee(s.currentClass)).forEach(function (e) {
          ...
          var _n7 = 1,
              _l7 = 1;
          "horizontal" === _i13 ? _n7 = _r11 : _l7 = _r11, e.querySelectorAll(ee(s.progressbarFillClass)).forEach(function (e) {
    ...
    function m() {
      ...
      if ("bullets" === e.type) {
        ...
        for (var _s28 = 0; _s28 < _a20; _s28 += 1) {
          e.renderBullet ? r += e.renderBullet.call(t, _s28, e.bulletClass) : r += "<".concat(e.bulletElement, " ").concat(t.isElement ? 'part="bullet"' : "", " class=\"").concat(e.bulletClass, "\"></").concat(e.bulletElement, ">");
        }
      }
    ...
    function x(e) {
      ...
      if (l = !1, d = !1, u.push(e), !(u.length < 2)) {
        ...
        if (m.imageEl) {
          ...
          m.originX = _e50, m.originY = _t39, m.imageEl.style.transitionDuration = "0ms";
        }
    ...
    s({
      ...
      setTranslate: function setTranslate(e, s) {
        ...
        if (Array.isArray(a)) for (var _e53 = 0; _e53 < a.length; _e53 += 1) {
          a[_e53] !== s && a[_e53] instanceof l && o(a[_e53]);
    ...
    function c(e) {
      ...
      }), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (var _e55 = 0; _e55 < i; _e55 += 1) {
        h(s.slidesEl, "[data-swiper-slide-index=\"".concat(t.realIndex + _e55, "\"]")).forEach(function (e) {
          e.classList.add(r);
        });
      } else for (var _e56 = 0; _e56 < i; _e56 += 1) {
        s.slides[t.realIndex + _e56] && s.slides[t.realIndex + _e56].classList.add(r);
      }
          ...
          if (s < -t.minTranslate()) t.slideTo(t.activeIndex);else if (s > -t.maxTranslate()) t.slides.length < d.length ? t.slideTo(d.length - 1) : t.slideTo(t.slides.length - 1);else {
            if (r.freeMode.momentum) {
              if (c.velocities.length > 1) {
                var _e59 = c.velocities.pop(),
                    _s39 = c.velocities.pop(),
                    _a24 = _e59.position - _s39.position,
                    _i17 = _e59.time - _s39.time;

                t.velocity = _a24 / _i17, t.velocity /= 2, Math.abs(t.velocity) < r.freeMode.minimumVelocity && (t.velocity = 0), (_i17 > 150 || l() - _e59.time > 300) && (t.velocity = 0);
              } else t.velocity = 0;
              ...
              var _s38 = t.velocity * _e58;

              var _p3 = t.translate + _s38;
              ...
              if (_p3 < t.maxTranslate()) r.freeMode.momentumBounce ? (_p3 + t.maxTranslate() < -_h && (_p3 = t.maxTranslate() - _h), _u3 = t.maxTranslate(), _m2 = !0, c.allowMomentumBounce = !0) : _p3 = t.maxTranslate(), r.loop && r.centeredSlides && (_f = !0);else if (_p3 > t.minTranslate()) r.freeMode.momentumBounce ? (_p3 - t.minTranslate() > _h && (_p3 = t.minTranslate() + _h), _u3 = t.minTranslate(), _m2 = !0, c.allowMomentumBounce = !0) : _p3 = t.minTranslate(), r.loop && r.centeredSlides && (_f = !0);else if (r.freeMode.sticky) {
                ...
                for (var _t41 = 0; _t41 < d.length; _t41 += 1) {
                  if (d[_t41] > -_p3) {
                    _e60 = _t41;
                    break;
                  }
      ...
      updateWrapperSize: function updateWrapperSize(e, s, a) {
        ...
        if (r.virtualSize = (e + l) * t, r.virtualSize = Math.ceil(r.virtualSize / d) - l, r.wrapperEl.style[a("width")] = "".concat(r.virtualSize + l, "px"), i) {
          ...
          for (var _t42 = 0; _t42 < s.length; _t42 += 1) {
            var _a27 = s[_t42];
            n && (_a27 = Math.floor(_a27)), s[_t42] < r.virtualSize + s[0] && _e61.push(_a27);
          }
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _s42 = 0; _s42 < e.length; _s42 += 1) {
          ...
          _n8.style.opacity = _r17, _n8.style.transform = "translate3d(".concat(_a28, "px, ").concat(_i18, "px, 0px)");
        }
      },
    ...
    ne({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e63 = 0; _e63 < a.length; _e63 += 1) {
          ...
          var _d5 = Math.max(Math.min(_t43.progress, 1), -1);
          ...
          _d5 <= 1 && _d5 > -1 && (h = 90 * _s43 + 90 * _d5, l && (h = 90 * -_s43 - 90 * _d5)), _t43.style.transform = _v, c.slideShadows && i(_t43, _d5, p);
        }
        ...
        if (s.style.transformOrigin = "50% 50% -".concat(o / 2, "px"), s.style["-webkit-transform-origin"] = "50% 50% -".concat(o / 2, "px"), c.shadow) if (p) m.style.transform = "translate3d(0px, ".concat(r / 2 + c.shadowOffset, "px, ").concat(-r / 2, "px) rotateX(90deg) rotateZ(0deg) scale(").concat(c.shadowScale, ")");else {
          var _e64 = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
              _t44 = 1.5 - (Math.sin(2 * _e64 * Math.PI / 360) / 2 + Math.cos(2 * _e64 * Math.PI / 360) / 2),
              _s44 = c.shadowScale,
              _a29 = c.shadowScale / _t44,
              _i19 = c.shadowOffset;
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e65 = 0, _t46 = a.length; _e65 < _t46; _e65 += 1) {
          var _t47 = a[_e65],
              _s45 = i[_e65],
              _l9 = (o - _t47.swiperSlideOffset - _s45 / 2) / _s45,
          ...
          if (le(0, _t47).style.transform = _b, _t47.style.zIndex = 1 - Math.abs(Math.round(_p5)), r.slideShadows) {
            var _e66 = n ? _t47.querySelector(".swiper-slide-shadow-left") : _t47.querySelector(".swiper-slide-shadow-top"),
                _s46 = n ? _t47.querySelector(".swiper-slide-shadow-right") : _t47.querySelector(".swiper-slide-shadow-bottom");

            _e66 || (_e66 = de("coverflow", _t47, n ? "left" : "top")), _s46 || (_s46 = de("coverflow", _t47, n ? "right" : "bottom")), _e66 && (_e66.style.opacity = _p5 > 0 ? _p5 : 0), _s46 && (_s46.style.opacity = -_p5 > 0 ? -_p5 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
        ...
        var _loop = function _loop(_s47) {
          ...
          if (h && f.shadow || !h) {
            ...
            if (!_e68 && f.shadow && (_e68 = de("creative", a)), _e68) {
              ...
              _e68.style.opacity = Math.min(Math.max(Math.abs(_t48), 0), 1);
            }
          }
